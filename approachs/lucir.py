...
class Appr(Inc_Learning_Appr):
    ...
    def pre_train_process(self, t, trn_loader):
        ...
        if t == 0:
            ...
            if self.model.model.__class__.__name__ == 'ResNet':
                old_block = self.model.model.c9[-1]
                self.model.model.c9[-1] = BasicBlockNoRelu(old_block.residual_function, old_block.shortcut)
            else:
    ...
    def train_epoch(self, t, trn_loader):
        ...
        for images, targets in trn_loader:
            ...
            loss = self.criterion(t, outputs, targets.long(), ref_outputs, features, ref_features, lwsoutputs)
            # Backward
...
class BasicBlockNoRelu(nn.Module):
    ...
    def __init__(self, residual_function, shortcut):
    ...
    def forward(self, x):
        ...
        out += self.shortcut(residual)+out
        # Removed final ReLU
        return out
